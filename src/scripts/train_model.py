...
from models.e3nn.model import E3NNModelWrapper
...
if __name__ == "__main__":
    ...
    # Assuming the dataloader has this information
    num_classes = 219

    # Initialize E3NN model
    model = E3NNModelWrapper(
    ...
    # Train the model
    print("\n" + "=" * 70)
    print("Training E3NN model with .fit() method...")
    print("=" * 70)
